...
레진코믹스 서비스를 더욱 아름답고 풍성하게 만들어 주실 디자이너 님을 모십니다.
...
- 포트폴리오
	* 본인의 대표 작업으로만 선별하여 PDF로 만들어주세요. 
	* 각 작업물에 대한 상세 설명 (문제 정의, 아이디어 전개과정, 결과가 보여지도록)을 반드시 넣어주세요.
 	* 포트폴리오에 기재되지 않은 작업은 이력서의 경력 기술서로 넣어주세요
- 이력서 & 경력 기술서 
