...
저희는 양질의 만화 콘텐츠를 제작/유통하고, 만화 기반 원천콘텐츠를 이용하여 영화/게임 등 다양한 미디어로 연계하는 **트랜스미디어 전문 기업**을 만들고자 합니다. 이를 위해 엔씨소프트로 부터 50억의 투자를 유치하였고, CJ E&M / 판타지오등 국내외의 유수 기업들과 협력하고 있으며, 곧 일본 진출을 앞두고 있습니다. 

레진엔터테인먼트의 **트랜스미디어 사업**을 담당하실 분들을 모십니다.
...
- 원작 기획 제작 및 영상화 PD
	- 10년차 내외 경력자 1명 , 5년차 내외 경력자 1명
	- 트랜스미디어적으로 확장 가능한 원천콘텐츠 제작
	- 원작을 활용한 영상화(영화, 드라마, 웹드라마 등) 제작
	- 레진엔터테인먼트 자체 영상 프로젝트 제작 관리

- 신규 콘텐츠 사업 담당자
	- 5년차 내외 경력자 1명
	- 게임 및 신규 콘텐츠 사업 프로젝트
	- 웹툰 원작을 활용한 신규 콘텐츠 사업
	- 웹툰-게임 연계프로젝트
	- 기타 신규 콘텐츠(캐릭터 라이센싱 등) 사업

## 기타 지원 자격 & 우대 사항

- **영화, 만화와 장르소설,애니메이션 등 콘텐츠 분야 전반**을 매우 좋아하시는 분.
...
- 면접은 1차 면접 ( 트랜스미디어팀 ) / 2차 면접 ( 임원 ) 로 진행합니다.
