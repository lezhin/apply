...
저희와 함께하실 분들을 모십니다! 상세 지원 방법은 아래 내용과 직군별 공고를 참고하세요.
 ...
 - 디자이너 ( 모바일앱,웹 )
 - 마케팅 / 홍보 담당자
    - 마케팅 기획 및 진행 , 효과 분석 , 홍보
 - 콘텐츠 및 서비스 담당자
    - 콘텐츠 수급 / 검수 / 서비스 운영
 - 고객센터 담당자 ( 이메일/전화 및 SNS 대응 )
...
이메일 지원 : **devapply@lezhin.com** 으로 위 서류들을 보내주세요. 메일내용에 희망 연봉을 꼭 적어주세요.

저희는 작은 인력으로 빠르게 움직이면서 키워나가고 있는 스타트업인지라 들어오시자 마자 바로 특정 분야에서 Post 를 담당하셔야 하므로, 자신 있으신 분야에 대한 설명과 저희 서비스와 팀내에서 어떻게 그걸 발휘하시고 가치를 더할 수 있는 지를 상세히 어필해주시면 가장 좋습니다.
