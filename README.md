...
- **지원자격은 위에 안내된 직군 별로 조금씩 다를 수 있으니 상세 채용공고를 참고하세요.**
...
- 면접은 1차 실무면접과 2차 임원면접으로 진행합니다.
- 1차 실무면접은 지원 분야에 따라 진행 방식이 상이할 수 있습니다.
- 면접결과는 전화 혹은 이메일로 개별 안내해드립니다.
