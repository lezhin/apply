...
- 만화사이트 운영 업무에 종사하신 분
	- 비경력자의 경우, 6개월의 수습과정 후 정직원 전환을 검토합니다.
- 일본어 상급이상 (JPT / JLPT 점수 기재 필수)  
- Photoshop 활용 능력 상급이상

## 기타 지원 자격 & 우대 사항

- **만화를 매우 좋아하셔야 합니다**. 이게 가장 중요합니다.
- 분야 불문 쇼핑몰의 운영경험이 있으신 분
- 상품 구매와 판매의 프로세스 경험이 있으신 분
- SNS활용에 익숙하신 분
- 일본에서 장기 거주하신 분
...
- 자기 소개서(한국어 / 일본어 작성)   :  자신이 푹 빠져 있거나 잉여스러운 내용도 꼭꼭 적어주세요. 
- 일본 레진코믹스 사용성 및 개선안에 대한 리포트 - 하기에 대한 내용이 포함되어야 합니다.
	- 레진코믹스 일본 사이트에서 만화를 더 잘 판매할수 있는 방법
	- 레진코믹스 일본 사이트에서 추가되었으면 하는 기능
	- 레진코믹스 일본 사이트 운영에 대한 로드맵
- 일본의 만화앱(1곳 이상)과 web기반 만화사이트(1곳 이상)에 대한 사용성 및 개선안에 대한 리포트 - 분량, 형식은 자유롭게 작성해주세요.
