...
레진코믹스의 수많은 데이터들을 분석하고 이를 비즈니스 결정에 도움주는 정보로 만들어 주실 **데이터 엔지니어**를 모십니다.
...
- Hadoop eco-system(Hadoop, Spark, Impala, Kafka, Hive, Oozie) 관련 경험 2년 이상 있으신 분
- Java, Scala, Python 중 한 가지 이상 프로그래밍 스킬 보유하신 분
