...
국내를 시작으로 해외로도 성장하는 레진코믹스를 더욱 더 훌륭하게 만들어 주실 능력 있는 **프론트엔드 개발자**를 모십니다.
...
- Single Page Application (SPA) 개발 경험
- AngularJS 개발 경험
- Webpack, Rollup 등의 모듈 번들러 경험
- 사용자의 요구 반영에 재미를 느끼는 분

## 우대사항

- Angular, React, Vue.js 경험
- 백오피스 개발 경험
- HTTP(RESTFul) API 디자인 경험
- Node.js 개발 경험
